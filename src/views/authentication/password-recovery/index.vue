<template>
  <div class="authentication-password-recovery">
    <section class="section-default">
      <el-container>
        <el-row :gutter="16" type="flex" justify="center">
          <el-col :xs="24" :sm="12" :md="10" :lg="8" :xl="6">
            <div class="authentication-password-recovery__headline">
              <h1 class="authentication-password-recovery__headline-title">Password recovery</h1>
            </div>
            <div class="authentication-password-recovery__form">
            ...
            <div class="authentication-password-recovery__navigation">
              <div class="authentication-password-recovery__navigation-return">
                <router-link :to="{ name: 'HomeIndex' }">Back</router-link>
              </div>
              <div class="authentication-password-recovery__navigation-login">
...
// Models
import { AuthenticationPasswordRecovery } from "@/models/authentication/password-recovery";
...
export default class AuthenticationPasswordRecoveryIndex extends Vue {
  isLoading = false;

  formData: AuthenticationPasswordRecovery = new AuthenticationPasswordRecovery();
  formDataRules = {
    email: [
      {
        required: true,
